...
public interface CommentsApi {
    ...
    @Operation(summary = "Create new comment", description = "", tags={ "comment" })
    @ApiResponses(value = {
    ...
    ResponseEntity<Comment> createComment(@Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody CommentCreate body);


    @Operation(summary = "Delete comment", description = "", tags={ "comment" })
    @ApiResponses(value = {
            @ApiResponse(responseCode = "204", description = "Comment deleted"),
            @ApiResponse(responseCode = "404", description = "Comment not found") })
    @RequestMapping(value = "/comments/{commentId}",
            method = RequestMethod.DELETE)
    ResponseEntity<Void> deleteComment(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("commentId") Integer commentId);


    @Operation(summary = "Get comment by ID", description = "", tags={ "comment" })
    @ApiResponses(value = {
    ...
    ResponseEntity<Comment> getCommentById(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("commentId") Integer commentId);


    @Operation(summary = "Update comment", description = "", tags={ "comment" })
    @ApiResponses(value = {
